...
| Role | Responsibility |
|------|---------------|
| **Business Analyst (BA)** | Talks to clients to understand the problem and translates business needs into clear requirements for the tech team |
| **Product Manager (PM)** | Decides what product to build, why, and when — owns the big picture and roadmap |
| **Product Owner (PO)** | Works closely with the dev team, manages the backlog, and decides what gets built first |
